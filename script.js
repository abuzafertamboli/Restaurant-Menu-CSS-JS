...
function displayMenuBtns() {
    ...
    // creating HTML buttons fore categories
    const categoryBtns = categories.map((categoryItems) => {
        return `<button class="filter-btn" type="button" data-id=${categoryItems}>${categoryItems}</button>`;
    }).join('');
